        ...
        <>
             <header 
                ...
                <div className="flex justify-center items-center h-full absolute top-0 left-0 w-full">
                    <h1 className="text-white text-5xl font-bold relative">
                        CONTACT US
                        <div className="absolute left-1/2 -bottom-2 transform -translate-x-1/2 h-1 w-[30] bg-white"></div>
                    </h1>
                </div>
            </header>
